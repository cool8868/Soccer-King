 ...
 *********************************************************************************/
#ifndef __NOFOULLEVELSTATUS_H__
#define __NOFOULLEVELSTATUS_H__

/// Represents the status that player will never foul.    
class NoFoulLevelStatus : public INoFoulLevelStatus 
{
public:
