 ...
 *********************************************************************************/
#ifndef __ACTIONSKILLCACHE_H__
#define __ACTIONSKILLCACHE_H__

#include "../../common/common.h"
#include "../../Interface/Skill/IRawSkill.h"

class ActionSkillCache
{
public:

    ActionSkillCache();

    virtual ~ActionSkillCache();

public:

    /// Get the instance of the <see cref="ActionSkillCache"/> class.
