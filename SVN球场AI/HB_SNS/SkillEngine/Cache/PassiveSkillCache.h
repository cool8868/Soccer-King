 ...
 *********************************************************************************/
#ifndef __PASSIVESKILLCACHE_H__
#define __PASSIVESKILLCACHE_H__

#include "../../common/common.h"
#include "../../Interface/Skill/IRawSkill.h"

class PassiveSkillCache
{
public:

    PassiveSkillCache();

    virtual ~PassiveSkillCache();
