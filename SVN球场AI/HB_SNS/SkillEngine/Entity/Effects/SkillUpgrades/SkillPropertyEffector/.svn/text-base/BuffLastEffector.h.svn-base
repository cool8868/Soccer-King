 ...
 *********************************************************************************/
#ifndef __BUFFLASTEFFECTOR_H__
#define __BUFFLASTEFFECTOR_H__

/// Represents a effector that will effects the buff's lasting time.
class BuffLastEffector : public ISkillPropertyEffector 
{
public:
