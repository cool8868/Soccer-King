 ...
 *********************************************************************************/
#ifndef __DEBUFFRATEEFFECTOR_H__
#define __DEBUFFRATEEFFECTOR_H__

/// Debuff的效果改变效果器
class DebuffRateEffector : public ISkillPropertyEffector
{
public:
...
#endif //__DEBUFFRATEEFFECTOR_H__
