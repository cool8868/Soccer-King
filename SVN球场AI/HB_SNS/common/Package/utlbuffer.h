...
//
// $Header: /cvs/myengine/src_main/public/valve/utlbuffer.h,v 1.1 2008/02/29 00:05:46 easap\albertyang Exp $
// $NoKeywords: $
//
...
public:
	...
	int GetUTF(char* pString, int nMaxLen = 0);
	...
	void PutUTF(char const * pString);
