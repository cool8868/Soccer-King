...
namespace Deepleo.Weixin.SDK
{
    ...
    public class OAuth2API
    {
        ...
        public static dynamic GetAccessToken(string code, string appId, string appSecret)
        {
            ...
            var result = client.GetAsync(string.Format("https://api.weixin.qq.com/sns/jscode2session?appid={0}&secret={1}&code={2}&grant_type=authorization_code", appId, appSecret, code)).Result;
